...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        choices=["dumby", "greedy", "smarty", "leftrandy"], default="leftrandy")
    parser.add_argument(
        '--layout',
    ...
    parser.add_argument(
        ...
        type=int, default=nbrGhosts)
    parser.add_argument(
        '--hiddenghosts',
        help='Whether the ghost is graphically hidden or not.',
        default=defaultHiddenGhosts, action="store_true")
    parser.add_argument(
        '--silentdisplay',
    ...
    total_score, total_computation_time, total_expanded_nodes = runGame(
        layout, agent, gagts, bsagt, not silentDisplay,
